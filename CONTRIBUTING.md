# Contributing  to the java-codable
...
[existing issues](https://github.com/pakistancan/java-codable/issues) trying a
...
Once you're ready, create an issue on [GitHub](https://github.com/pakistancan/java-codable/issues).
...
(for target version see [pom.xml](pom.xml)).
...
committer for the java-codable.
